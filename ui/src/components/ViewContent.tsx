              ...
              <>
                ...
                <div class={styles.viewToolbar}>
                  ...
                  <span class={styles.resultCount}>
                    {ticketRecords.loading ? "Loading" : `${records().length} issues`}
                  </span>
                </div>
                              ...
                              <thead>
                                <tr>
                                  <For each={presentation()?.fields}>
                                    {(field) => (
                                      <th style={{ width: field.width ? `${field.width}px` : undefined }}>
                                        {field.label}
                                      </th>
                                    )}
                                  </For>
      ...
      >
        {(administration) => (
          <>
            <div class={styles.viewHeading}>
              <div>
                <p class={styles.eyebrow}>Administration</p>
                <h1>{administration().name}</h1>
              </div>
            </div>
            <Dynamic component={administration().content} />
          </>
        )}
      </Show>
    </main>
