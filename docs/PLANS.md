...
```text
docs/plans/2026-05-25-template-validation-plan.md
```
...
For example, include items for adding tests, running checks, and validating user-facing behavior when those are part of the work.
...
- adding or updating fixtures or sample inputs
- running `nao check`
